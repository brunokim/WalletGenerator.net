"pt": {
  "choosecurrency": "Escolha a moeda",
    ...
    "bulklabelcsv": "Valores separados por vírgula: Índice,Endereço,Chave Privada(WIF)",
    ...
    "detaillabelnote1": "Sua Chave Privada é um segredo único que só você sabe. Ela pode ser codificada em diferentes formatos. Abaixo estão o Endereço Público e a Chave Pública que correspondem a sua Chave Privada, assim como sua Chave Privada na maioria dos formatos populares (WIF, WIFC, HEX, B64).",
    ...
    "brainalertpassphrasewarning": "Aviso: Escolher uma senha forte é importante para evitar ataques de força bruta para adivinhar sua senha e roubar seus fundos.",
    "brainalertpassphrasetooshort": "A senha que você inseriu é muito pequena.",
